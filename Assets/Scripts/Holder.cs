...
public class Holder : MonoBehaviour
{
	...
	public int proton_num;
	public int neutron_num;
    ...
    private Vector3 nucleus_scale; 
    private float nucleus_radius;
    ...
    Vector3 segment_switch(int i ,Orbits o){
    	...
    	if (i>1 && i<10){ //LEVEL L
    		...
    		var rot = Quaternion.AngleAxis(arc*i,Vector3.up);//o.nucleo.transform.up);
